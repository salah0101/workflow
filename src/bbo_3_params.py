...
def objf(x):
  ...
  x_to_display=x.append(sum_objs)
...
for desc,l in lopt:
  ...
  d=pd.DataFrame(allEvaluated,columns=["q","w","a"])
...
print("Training,",desc,",",str(objf_pure(r[0],learned=True)),sep="")
print("***************************")
...
print("required training time :: ", str(end-start))
